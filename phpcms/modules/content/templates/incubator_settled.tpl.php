...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center" width="150"><?php echo format::date($info['settletime'],1);?></td>
		...
		<td align="center" width="12%"><a href="###"
			...
			title="<?php echo '详情';?>"><?php echo '查看';?></a>
		</td>
	</tr>
	<?php
	}
...
<script type="text/javascript">
	function edit(id, name) {
		...
		window.top.art.dialog({title:'<?php echo '查看';?> '+name+' ',id:'edit',iframe:'?m=content&c=content&a=settledpreview&id='+id,width:'700',height:'450'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
	}
</script>
</body>
</html>

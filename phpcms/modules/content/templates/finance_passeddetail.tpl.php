...
<div class="pad_10">
<form action="?m=content&c=content&a=fpassedpre&id=<?php echo $id; ?>" method="post" name="myform" id="myform">
...
<table cellpadding="2" cellspacing="1" class="table_form" style="margin-top: 20px;" width="100%">	
	...
	<tr>
		<th width="25%"><?php echo '提交时间'; ?></th>
		<td><?php echo format::date($info['inputtime'],1);?></td>
	</tr>
	<tr>
		<th width="25%"><?php echo '通过审核时间'; ?></th>
		<td><?php echo format::date($info['updatetime'],1);?></td>
	</tr>

	<tr>
		<th></th>
		<td>
			<input type="hidden" name="forward" value="?m=content&c=content&a=fpassedpre">

...
<script type="text/javascript">
	function edit(id, name) {
		...
		window.top.art.dialog({title:'<?php echo '查看';?> '+name+' ',id:'edit',iframe:'?m=content&c=content&a=passedpreview&id='+id,width:'700',height:'450'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
	}
</script>
</body>
</html>

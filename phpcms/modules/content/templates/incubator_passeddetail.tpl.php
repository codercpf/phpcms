...
<div class="pad_10">
<form action="?m=content&c=content&a=passedpreview&id=<?php echo $id; ?>" method="post" name="myform" id="myform">
...
<table cellpadding="2" cellspacing="1" class="table_form" style="margin-top: 20px;" width="100%">	
	...
	<tr>
		<th width="25%"><?php echo '已经入驻'?>：</th>
		<td>
			<input name="applysettled" type="radio" value="是">&nbsp;是&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<tr>
		<th></th>
		<td>
			<input type="hidden" name="forward" value="?m=content&c=content&a=passedpreview">

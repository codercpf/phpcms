    ...
    <div class="front">
      ...
      <div class="main">
        ...
        <div class="main-login">
          <form accept-charset="UTF-8" action="<?php echo APP_PATH;?>index.php?m=member&c=index&a=login" autocomplete="off" name="loginForm" 
            ...
            <div class="form-group">
              ...
              <input aria-required="true" autocomplete="false" class="string required form-control" id="userAccount" 
                    name="userAccount" placeholder="请输入邮箱" type="text" datatype="e" nullmsg="请输入邮箱账号" ajaxurl="?m=member&c=index&a=public_loginEmail_ajax">
              <p class="Validform_checktip"></p>
              </div>
              <div>
              <input autocomplete="false" class="password optional form-control" id="userPass" 
                    name="userPass" placeholder="请输入密码，不少于6位" type="password"  datatype="*6-18" nullmsg="请输入密码" errormsg="密码至少6个字符,最多18个字符！">
              <p class="Validform_checktip"></p>
              </div>
            </div> 
            <div class="form-group">
...
<script type="text/javascript">
    $(function(){
        var demo = $('form[name="loginForm"]').Validform({
            tiptype:3,
            showAllError:true,
            ajaxPost:false
        });        

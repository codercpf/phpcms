    ...
    <div class="front">
      <header class="header">
        ...
        <div class="header-help">
          <a href="about.html" target="_blank" class="header-help__btn">帮助</a>
        </div>
        ...
        <div class="main-login">
          <form accept-charset="UTF-8" action="" autocomplete="off" 
            ...
            <div class="actions cf">                        
              ...
              <a class="forget" href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=getpassword" id="forgot_password">忘记密码</a>  
            </div>
          </form>
        </div>

    ...
    <div class="front">
      ...
      <div class="main">
        ...
        <div class="main-login">
          <form accept-charset="UTF-8" action="<?php echo APP_PATH;?>index.php?m=member&c=index&a=public_getpassword" 
            ...
            <div class="form-group">
              <input aria-required="true" autocomplete="false" class="string required form-control" id="userEmail" 
                  name="userEmail" placeholder="请输入邮箱" required="required" type="email">

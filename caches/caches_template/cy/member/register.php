    ...
    <div class="front">
      ...
      <div class="main">       
        ...
        <div class="main-login">
          ...
          <form accept-charset="UTF-8" action="<?php echo APP_PATH;?>index.php?m=member&c=index&a=register" name="regForm" autocomplete="off" class="simple_form new_user" method="post">

            <div class="form-group">
              <div>
              <input aria-required="true" autocomplete="false" class="string required form-control" id="userAccount" 
                    name="userAccount" placeholder="请输入邮箱" type="text" datatype="e" nullmsg="请输入邮箱账号" ajaxurl="?m=member&c=index&a=public_regEmail_ajax">
              <p class="Validform_checktip"></p>
              </div>
              <div>
              <input autocomplete="false" class="password optional form-control" id="userPass" 
                    name="userPass" placeholder="密码,6到18个字符" type="password" datatype="*6-18" nullmsg="请输入密码" errormsg="密码至少6个字符,最多18个字符！">
              <p class="Validform_checktip"></p>
              </div>
              <div>
              <input autocomplete="false" class="password optional form-control" id="confirmPass" 
                    name="confirmPass" placeholder="确认密码" type="password"  datatype="*" recheck="userPass" nullmsg="请输入确认密码" errormsg="两次输入的密码不一致！" />
            ...
            <div class="form-group">
              <input type="submit" class="btn input-submit" name="dosubmit" value="注册"></div>
...
<script type="text/javascript">
    $(function(){
        var demo = $('form[name="regForm"]').Validform({
            tiptype:3,
            showAllError:true,
            ajaxPost:false
        });        

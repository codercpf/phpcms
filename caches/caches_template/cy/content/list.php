...
<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
    <?php if($n==1) { ?><div class="content-item-notop content-item clearfix"><?php } else { ?><div class="content-item clearfix"><?php } ?>
        <div class="item-img fl">
            <a href="<?php echo $r['url'];?>" target="_blank">
            <img src="<?php echo thumb($r[thumb],186,118,0);?>" alt="" title="">
            </a>
        </div>
        <div class="item-info fr">
            ...
            <p class="item-intro">
                <?php echo str_cut($r[description],300);?>
            </p>
            <p class="item-other">
